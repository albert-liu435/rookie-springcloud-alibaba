...
public class CircleBreakerController {
    ...
    protected final Logger log = LoggerFactory.getLogger(CircleBreakerController.class);

    public static final String SERVICE_URL = "http://rookie-sentinelribbon-payment-provider";
